...
public class TecnicoRequest {
    ...
    @NotNull(groups = {ValidOnUpdate.class}, message = "id de Tecnico está invalido.")
    @JsonProperty("id")
    private Long id;
    ...
    public boolean equals (Object obj){
        ...
        return
                 Objects.equals(this.id, other.id) &&          Objects.equals(this.contratoInicio, other.contratoInicio) &&          Objects.equals(this.contratoFim, other.contratoFim) &&          Objects.equals(this.cidadeNascimento, other.cidadeNascimento);     }
