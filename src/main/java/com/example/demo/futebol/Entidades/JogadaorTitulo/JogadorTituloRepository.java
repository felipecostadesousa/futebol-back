...
public class JogadorTituloRepository implements JogadorTituloDao{
    ...
    public Optional<JogadorTitulo> findById(Integer id) {
        String jpql = "SELECT jogador_titulo FROM Jogador_Titulo jogador_titulo where jogador_titulo.id =: id_jogador_titulo";
    ...
    public List<JogadorTitulo> findAll() {
        String jpql = "SELECT jogador_titulo FROM Jogador_Titulo jogador_titulo";
    ...
    public Optional<JogadorTitulo> findByJogadorId(Integer jogadorId) {
        String jpql = "SELECT jogador_titulo FROM Jogador_Titulo jogador_titulo where jogador_id =: id_jogador";
    ...
    public Optional<JogadorTitulo> findByTituloId(Integer tituloId) {
        String jpql = "SELECT jogador_titulo FROM Jogador_Titulo jogador_titulo where titulo_id =: id_titulo";
